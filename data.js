/* ═══════════════════════════════════════════════════════
   MYCODELAB · js/data.js
   Single source of truth — mirrors repository.json
   ═══════════════════════════════════════════════════════ */
...
MCL.meta = {
  ...
  github:      'https://github.com/mycodelab',
...
MCL.categories = [
  {
    ...
    projects: [
      { id:'bisection',     title:'Bisection Method',        folder:'Bisection',     file:'Bisection_Method.py',  type:'py', language:'Python', author:'abhineet',
        description:'Guaranteed-convergence bracketing method for isolating roots of continuous functions. Implements adaptive step-halving with configurable tolerance and iteration bounds.',
        method:'Bisection (Bolzano)', output:'Root of f(x)=x³−2x−5: x* ≈ 2.09455  (tol=1e-10, 34 iters)', tags:['bracketing','bisection'] },
      { id:'newton-raphson', title:'Newton-Raphson Method', folder:'Newton-Raphson', file:'Newton_Raphson.py',    type:'py', language:'Python', author:'abhineet',
      ...
      { id:'secant',        title:'Secant & Regula Falsi',  folder:'Secant',        file:'Secant_Method.py',     type:'py', language:'Python', author:'agnik',
  ...
  },
  {
    ...
    projects: [
      { id:'simpson',        title:"Simpson's Rule",        folder:'Simpsons-Rule',       file:'Simpsons_Rule.py',          type:'py', language:'Python', author:'abhineet',
      ...
      { id:'gauss-legendre', title:'Gaussian Quadrature',   folder:'Gaussian-Quadrature', file:'Gaussian_Quadrature.py',    type:'py', language:'Python', author:'abhineet',
        description:'Gauss-Legendre nodes and weights up to order 20. Near-machine-precision with fewer evaluations than Newton-Cotes rules.',
        method:'Gauss-Legendre Quadrature', output:'∫₋₁¹ eˣ dx ≈ 2.35040  (n=5 pts, exact to 15 d.p.)', tags:['gaussian','high-order'] },
      { id:'monte-carlo',    title:'Monte Carlo Integration',folder:'Monte-Carlo',         file:'Monte_Carlo_Integration.py',type:'py', language:'Python', author:'agnik',
        description:'Stochastic integration in 1D, 2D, and 3D domains using importance sampling and variance reduction.',
  ...
  },
  {
    ...
    projects: [
      { id:'lu-decomp',    title:'LU Decomposition',              folder:'LU-Decomposition', file:'LU_Decomposition.py', type:'py', language:'Python', author:'abhineet',
      ...
      { id:'gauss-seidel', title:'Gauss-Seidel Iteration',       folder:'Gauss-Seidel',     file:'Gauss_Seidel.py',     type:'py', language:'Python', author:'agnik',
      ...
      { id:'eigenvalues',  title:'Power Iteration & Eigenvalues', folder:'Eigenvalues',      file:'Power_Iteration.py',  type:'py', language:'Python', author:'abhineet',
  ...
  },
  {
    ...
    projects: [
      { id:'rk4',      title:'Runge-Kutta 4th Order',  folder:'Runge-Kutta',    file:'RK4.py',             type:'py', language:'Python', author:'abhineet',
        description:'Classic RK4 integrator for systems of first-order ODEs applied to pendulum, Lotka-Volterra, and SIR models.',
        method:'Runge-Kutta RK4', output:'Pendulum T ≈ 2.0066 s  (θ₀=15°, l=1m)', tags:['runge-kutta','ivp'] },
      { id:'euler',    title:'Euler & Improved Euler',  folder:'Euler-Methods',  file:'Euler_Method.py',    type:'py', language:'Python', author:'agnik',
      ...
      { id:'shooting', title:'Shooting Method — BVP',   folder:'Shooting-Method',file:'Shooting_Method.py', type:'py', language:'Python', author:'abhineet',
        description:'Converts boundary value problems to IVP using Newton shooting. Solves quantum harmonic oscillator and buckling beam.',
  ...
  },
  {
    ...
    description: 'Discrete and fast Fourier transforms, spectral analysis, and convolution.',
    projects: [
      { id:'fft-analysis',    title:'FFT Signal Analysis',    folder:'FFT-Analysis',    file:'FFT_Analysis.py',    type:'py', language:'Python', author:'agnik',
        description:'Fast Fourier Transform for spectral analysis of time-series data with windowing functions (Hann, Blackman).',
        method:'FFT (Cooley-Tukey)', output:'Dominant frequency: 1.247 Hz  (SNR = 34.2 dB)', tags:['fft','spectral'] },
      { id:'dft-convolution', title:'DFT Convolution & Filters',folder:'DFT-Convolution',file:'DFT_Convolution.py',type:'py', language:'Python', author:'agnik',
  ...
  },
  {
    ...
    projects: [
      { id:'least-squares', title:'Least Squares Curve Fitting',  folder:'Least-Squares',file:'Least_Squares.py',      type:'py', language:'Python', author:'agnik',
      ...
      { id:'chi-squared',   title:'Chi-Squared Goodness of Fit', folder:'Chi-Squared',  file:'Chi_Squared_Test.py',  type:'py', language:'Python', author:'agnik',
  ...
  },
  {
    ...
    projects: [
      { id:'nbody',         title:'N-Body Gravitational Simulation',folder:'N-Body',        file:'NBody_Simulation.py',type:'py', language:'Python', author:'agnik',
      ...
      { id:'heat-equation', title:'Heat Equation — FD Solver',      folder:'Heat-Equation', file:'Heat_Equation.py',   type:'py', language:'Python', author:'abhineet',
  ...
  },
  {
    ...
    projects: [
      { id:'finite-diff-deriv', title:'Finite Difference Derivatives', folder:'Finite-Differences', file:'Finite_Differences.py', type:'py', language:'Python', author:'agnik',
  ...
  },
  {
    ...
    description: 'Direct and iterative methods for large linear systems in physics problems.',
    projects: [
      { id:'gaussian-elim',  title:'Gaussian Elimination',    folder:'Gaussian-Elimination', file:'Gaussian_Elimination.py',type:'py', language:'Python', author:'abhineet',
      ...
      { id:'conjugate-grad', title:'Conjugate Gradient Solver',folder:'Conjugate-Gradient',  file:'Conjugate_Gradient.py',  type:'py', language:'Python', author:'abhineet',
...
MCL.allProjects = MCL.categories.flatMap(cat =>
  cat.projects.map(p => ({ ...p, categoryId: cat.id, categoryName: cat.name, categoryIcon: cat.icon, categoryColor: cat.color }))
);
